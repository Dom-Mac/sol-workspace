 ...
 * @notice Difference form ENS token is that the Mint function has been marked as virtual
 */
contract ENSToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
     ...
     */
    function mint(address dest, uint256 amount) external virtual onlyOwner {
